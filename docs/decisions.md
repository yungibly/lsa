...
| 16 default attempts, 8 MiB image commands | Useful initial thumbnails without decoding an entire photo directory. User can raise attempts to 256. Cache hits and failures count. |
