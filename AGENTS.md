...
- Inline output is the default. Paging is explicit; directory browsing is outside the current product scope.
...
- Bound preview work, allocations, queues, cache storage, and output. Pager previews follow the viewport. Preview failures never hide files.
...
- Keep inline output and pager output lifetimes distinct, including progressive rendering and image cleanup.
